...
static inline ulong mulhi_split(ulong a, ulong b)
{
...
static inline ulong mullo_split(ulong a, ulong b)
{
    ulong r_mi, r_lo;
    ulong a_lo, a_hi;
    ulong b_lo, b_hi;
...
static inline __m256i avx2_mulhi_split(__m256i a, __m256i b)
{
...
static inline __m256i avx2_mulhi_split_v2(__m256i a, __m256i b)
{
...
static inline __m256i avx2_mullo_split(__m256i a, __m256i b)
{
...
static inline void avx2_mul_split(__m256i* hi, __m256i* lo, __m256i a, __m256i b)
{
    __m256i r_hi, r_mi, r_lo;
    __m256i a_hi;
    __m256i b_hi;
