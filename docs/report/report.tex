...
They are separated in families 
...
\begin{example}
    \texttt{vpmuludq} is an AVX2 instruction that multiplies the low unsigned 32-bit integers from packed 64-bit elements
...
\begin{itemize}
    \item used mullo from (url in comments)%\url{// https://stackoverflow.com/questions/37296289/fastest-way-to-multiply-an-array-of-int64-t/37320416#37320416}
    \item used mulhi from \cite{boemer2021intelhexlacceleratinghomomorphic}
\end{itemize}
...
op are pretty much the same problem 
