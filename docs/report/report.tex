...
We only present the results obtained with a modulus with a size between 32 and 64 bits.
...
\begin{itemize}
    ...
    \item remarks on timings could be stated here ?
\end{itemize} 
...
\begin{table}[h!]
    ...
    \begin{tabular}{|r|*{3}{c c|}}
        ...
        \hline
    \end{tabular}
    \caption{Timings in seconds and ratios of the modular sum with a modulus of 60 bits.}
\end{table}
...
\paragraph{Vector-vector multiplication} Given two vectors $a$, $b$ of $N$ coefficients in $\mathbb{Z}/n\mathbb{Z}$, we compute
\[
