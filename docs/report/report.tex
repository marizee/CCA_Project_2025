...
\subsection{Goals}
\begin{itemize}
    \item Implement basic arithemic operations (scalar-vector multiplication, vector-vector multiplication, dot product) using library FLINT.
...
Since the product $xy$ can have more than 64 bits, the output of this operation is usually given as a pair of words of at most 64 
