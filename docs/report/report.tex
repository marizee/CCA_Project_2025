...
%Le nombre premier choisi est un premier FFT de 50 bits. Le code marche aussi
%jusqu'à 62 bits avec les mêmes performances, mais j'ai mesuré sur 50 bits pour
%pouvoir comparer à la FFT basée sur les flottants déjà dans FLINT (qui elle ne
%peut pas aller au-delà de 50 bits).
